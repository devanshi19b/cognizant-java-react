...
#### Big O Notation
Big O notation describes the upper bound of an algorithm's time complexity — how the runtime grows as input size increases.
...
### ▶️ How to Run
```bash
cd "WEEK-1/DSA/e-Commerce Platform"
...
- Simplifies problems with naturally recursive structures.
...
### ▶️ How to Run
```bash
cd "WEEK-1/DSA/Financial Forcasting"
...
## 🛠️ Prerequisites
- Java JDK 8 or above
- Any IDE such as VS Code, IntelliJ, or Eclipse
